...
![EtherChannel](https://img.shields.io/badge/EtherChannel-PAgP%2FLACP-9cf)
...
**Routed Port / SVI / Inter-VLAN Routing / 동적 라우팅(EIGRP, OSPF) / EtherChannel** 을 다룹니다.  
...
| 핵심 주제 | ip routing, Routed Port, SVI, Inter-VLAN Routing, EIGRP, OSPF, EtherChannel |
| 실습 환경 | GNS3 / Cisco Packet Tracer |
| 키워드 | L3 Switch, no switchport, interface vlan, passive-interface, EIGRP, OSPF, EtherChannel, PAgP, LACP |
...
- **EtherChannel**: 다수 물리 링크를 1개 논리 링크로 묶어 대역폭 합산 + STP Blocking 회피 (PAgP/LACP)
...
| 구분 | PAgP | LACP |
| --- | --- | --- |
| 표준 | Cisco 전용 | IEEE 802.3ad 표준 |
| 최대 포트 | 8개 | 16개 (8 활성 + 8 대기) |
